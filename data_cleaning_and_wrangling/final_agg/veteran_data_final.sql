create or replace table `marketeam_data.veteran_data_final`
(sustainer int64,
gender int64,
...
from
  `marketeam_data.veteran_data_temp` d
left join
  `marketeam_data.veteran_samples` s
  on d.account_id = s.account_id
left join
  `marketeam_data.veteran_donor_clean` c
