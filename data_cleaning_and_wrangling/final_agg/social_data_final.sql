create or replace table `marketeam_data.social_data_final`
(sustainer int64,
gender int64,
...
from
  `marketeam_data.social_data_temp` d
left join
  `marketeam_data.social_samples` s
  on d.account_id = s.account_id
left join
  `marketeam_data.social_donor_clean` c
